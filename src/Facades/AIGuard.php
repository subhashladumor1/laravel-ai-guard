 ...
 * @method static AiUsage recordFromResponse(mixed $response, ?int $userId = null, ?string $tenantId = null, ?string $provider = null, ?string $model = null, ?string $tag = null, ?array $pricing = null)
 ...
 * @method static array estimate(string $prompt, ?string $model = null, ?string $provider = null, ?array $pricing = null)
